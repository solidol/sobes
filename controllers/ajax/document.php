...
$app->get('/ajax/document/getlist', function() use ($app) {
    ...
    foreach ($result as $k => $v) {
        ...
        $item['view'] = '<a href="'.$app['url_generator']->generate('clerk.doc.type1.view', 
                    array('year' => $v['year'],
                        'pref1' => $v['num_prefix_1'],
                        //'pref2' => (($v['num_prefix_2']!='')?$v['num_prefix_2']:$v['num_prefix_1']),
                        'no' => $v['internal_number'])).'"><i class="fa fa-file-text-o fa-2x" aria-hidden="true"></i></a>';
        
        $item['edit'] = '<a href="'.$app['url_generator']->generate('clerk.doc.type1.edit', 
                    array('year' => $v['year'],
                        'pref1' => $v['num_prefix_1'],
                        //'pref2' => (($v['num_prefix_2']!='')?$v['num_prefix_2']:$v['num_prefix_1']),
                        'no' => $v['internal_number'])).'"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>';
        
        $item['arch'] = '<a href="'.$app['url_generator']->generate('clerk.doc.type1.view', 
                    array('year' => $v['year'],
                        'pref1' => $v['num_prefix_1'],
                        //'pref2' => (($v['num_prefix_2']!='')?$v['num_prefix_2']:$v['num_prefix_1']),
                        'no' => $v['internal_number'])).'"><i class="fa fa-archive fa-2x" aria-hidden="true"></i></a>';
        $arDocs['data'][] = $item;
    }
